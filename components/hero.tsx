...
function HeroContent({
  ...
  return (
    <div className="flex flex-col space-y-4">
      ...
      <motion.p
        className="max-w-[42rem] leading-normal text-neutral-500 sm:text-xl sm:leading-8 dark:text-neutral-400"
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
...
const Hero = ({ pill, content, preview }: HeroProps) => {
  return (
    <div className="container relative overflow-hidden mx-auto">
      <div className="flex lg:min-h-[calc(100vh-64px)] flex-col lg:flex-row items-center py-8 px-4 md:px-8 lg:px-12">
        <div className="flex flex-col gap-4 w-full pt-16 md:pt-0">
          {pill && <HeroBadge {...pill} />}
          <HeroContent {...content} />
        </div>
        {preview && (
